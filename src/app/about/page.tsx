      ...
      <div className="w-full max-w-4xl px-4 py-8 shadow-md rounded-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4  rounded-lg shadow-md">
            ...
            <p className="text-md">
              Huhumuza AI isn’t just an AI; it’s a friend who is designed to understandsand your feelings. Whether you're dealing with anxiety, depression, or situational stress, Huhumuza is there to listen and provide comfort.
            </p>
          </div>
          <div className="p-4 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-2">Accessible Anytime, Anywhere</h3>
            <p className="text-md">
              In a world where more than 50% of adults with mental illness don’t receive the care they need due to cost or other barriers, Huhumuza AI breaks down these obstacles by being available anytime you need to talk.
            </p>
          </div>
          <div className="p-4 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-2">Support for All Ages</h3>
            <p className="text-md">
              Mental health challenges can begin as early as age 14, with more than 45% of lifelong mental illnesses starting by this age. Huhumuza AI provides support for users of all ages, from adolescents to adults, ensuring that no one faces their struggles alone.
            </p>
          </div>
          <div className="p-4 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-2">Combatting Isolation</h3>
            <p className="text-md">
              During the COVID-19 pandemic, more than 40% of adults report that the pandemic harms their mental health. Huhumuza AI provides a supportive connection, helping to alleviate feelings of isolation and loneliness.
            </p>
          </div>
        </div>
      </div>
